...
public class Partida {
    ...
    public static void main(String[] args) throws InterruptedException {
        try {
            ...
            // Creamos y mostramos el diálogo de bienvenida
            mostrarSaludo();
            partida.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
            tableroJugador.setBorder(new EmptyBorder(0,5,0,25));
            tableroCPU.rotar.setVisible(false);
    ...
    /** 
     * Mediante un diálogo se da la bienvenida al jugador
     */ 
    ...
    /** 
     * Muestra un diálogo cuando un misil de la CPU impacte en algún barco del Jugador
     */ 
    ...
    */
    ...
    /** 
     * Muestra por diálogo el resultado de la partida
     */ 
    ...
    /** 
     * Actualiza el marcador en función del resultado
     */ 
